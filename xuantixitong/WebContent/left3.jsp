												...
												<td width="89" height="35"><table width="100%"
														...
														<tr>
															<td height="23" style="cursor: hand"
																...
																class="STYLE2">&nbsp;<a
																	href="student/stu1.jsp" target="main">个人信息管理</a></span></td>
														</tr>
													</table></td>
											</tr>
												...
												<td width="89" height="35"><table width="100%"
														...
														<tr>
															<td height="23" style="cursor: hand"
																...
																onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span
																class="STYLE2">&nbsp;<a
																	href="student/stu_select_proj.jsp" target="main">选题登记</a></span></td>
														</tr>
													</table></td>
											</tr>
											<tr>
												...
												<td height="35"><table width="100%" border="0"
														...
														<tr>
															<td height="23" style="cursor: hand"
																...
																onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span
																class="STYLE2">&nbsp;<a
																	href="student/select_stu_proj.jsp" target="main">已选查询</a></span></td>
														</tr>
													</table></td>
											</tr>
												...
												<td width="89" height="35"><table width="100%"
														...
														<tr>
															<td height="23" style="cursor: hand"
																...
																onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span
																class="STYLE2">&nbsp;<a
																	href="student/tijiao.jsp" target="main">论文提交</a></span></td>
														</tr>
													</table></td>
											</tr>
											<tr>
												...
												<td height="35"><table width="100%" border="0"
														...
														<tr>
															<td height="23" style="cursor: hand"
																...
																onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span
																class="STYLE2">&nbsp;<a
																	href="student/lunwen_view.jsp" target="main">论文查看</a></span></td>
														</tr>
													</table></td>
											</tr>
												...
												<td width="89" height="35"><table width="100%"
														...
														<tr>
															<td height="23" style="cursor: hand"
																...
																onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span
																class="STYLE2">&nbsp;<a
																	href="student/stu_grade.jsp" target="main">成绩查看</a></span></td>
														</tr>
													</table></td>
											</tr>
